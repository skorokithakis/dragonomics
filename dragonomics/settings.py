"""
Django settings for dragonomics project.
...
MIDDLEWARE = [
    ...
    "dragonomics.middleware.StatsMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "dragonomics.context_processors.settings",
            ]
        },
    }
]
...
WSGI_APPLICATION = "dragonomics.wsgi.application"
